...
public class P_Plus_011 {
	...
	public void p_schedule_011() throws Exception {
		...
		String Single = ".//*[@id='scheduleItem']/ul[11]/li/a[1]"; //단일상품
		String dobulePro =".//*[@id='scheduleItem']/ul[11]/li[1]/a[1]"; //복수상품
		String singleCon= ".//*[@id='scheduleItem']/ul[11]/li/div/div/span"; // 상담상품
		String dobuleCon= ".//*[@id='scheduleItem']/ul[11]/li[1]/div/div/span"; // 상담상품
