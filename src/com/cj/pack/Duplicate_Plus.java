...
//그냥 생성자
  public Duplicate_Plus(WebDriver Driver){
		driver = Driver;
	...
	public void schedule(String single,String dobulePro,String singleCon,String doubleCon) throws InterruptedException {
		...
		// 앱다운로드로 이동
		WebElement searchBtn3 = driver.findElement(By.xpath("//*[@id=\"_RECOMMEND\"]/div[1]"));
